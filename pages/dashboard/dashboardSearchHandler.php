 ...
 echo '<nav class="navbar fixed-top navbar-dark fixed-top-2">';
        ...
        echo '<ul class="navbar-nav" id="back">';
            echo '<li class="nav-item active">';
                echo '<a href="dashboard.php"><i class="fas fa-arrow-circle-left fa-2x"></i></a>';
            echo '</li>';
        echo '</ul>';
...
while($userProfile = mysqli_fetch_array($result))
 {
            ...
            echo '<div class="card">';
                echo '<div class="card-header">';
                    echo '<div class="align-items-center">';
                        echo '<h5>' . $userProfile['fname'] . ' ' . $userProfile['lname'] . '</h5>';
                        echo '<h6>UID: #000' . $userProfile['userID'] . '</h6>';
                    echo '</div>';
                echo '</div>';
                echo '<div class="card-body">';
                    echo '<p>' . $userProfile['bAge'] . ' Year(s) Old,  ' . $userProfile['gender'] . '</p>';
                    echo '<form action="personalWall.php" method="post">';
                       echo '<button type="submit" class="btn primary" name="profile" value="'. $userProfile['userID'] .'">View User Wall</button>';
                    echo '</form>';
                echo '</div>';
            echo '</div>';
        echo '</div>';
